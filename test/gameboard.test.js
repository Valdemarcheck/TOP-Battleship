...
test("Gameboard places horizontal 1x1 ship at certain coordinates", () => {
  ...
  board.place({ shipUI: ship, isVertical: false, startX: 10, startY: 10 });
...
test("Gameboard places horizontal 2x1 ship at certain coordinates", () => {
  ...
  const board = new Gameboard();
  board.place({ shipUI: ship, isVertical: false, startX: 5, startY: 5 });
...
test("Gameboard places vertical 2x1 ship at certain coordinates", () => {
  const ship = new Ship(2);
  const board = new Gameboard();
  board.place({ shipUI: ship, isVertical: true, startX: 5, startY: 5 });
  expect(board.isShipPlacedOnCoordinates(5, 5)).toBe(true);
...
test("Placing ships isn't allowed out of bounds (1)", () => {
  ...
  const board = new Gameboard();
  expect(() => {
    board.place({ shipUI: ship, isVertical: true, startX: 15, startY: 15 });
  }).toThrow();
});
...
test("Placing ships isn't allowed on a taken cell (1)", () => {
  ...
  board.place({ shipUI: ship1, isVertical: false, startX: 3, startY: 3 });
  expect(() => {
    board.place({ shipUI: ship2, isVertical: true, startX: 3, startY: 3 });
  }).toThrow();
});
...
test("Placing ships isn't allowed on a taken cell (2)", () => {
  ...
  board.place({ shipUI: ship1, isVertical: false, startX: 3, startY: 3 });
  expect(() => {
    board.place({ shipUI: ship2, isVertical: false, startX: 2, startY: 3 });
  }).toThrow();
});
...
test("receiveAttack works on ship cells", () => {
  ...
  board.place({ shipUI: ship, isVertical: false, startX: 3, startY: 3 });
...
test("areAllShipsSunk works for 1 ship", () => {
  ...
  const board = new Gameboard();
  board.place({ shipUI: ship, isVertical: false, startX: 1, startY: 1 });
...
test("areAllShipsSunk works for 2 ships", () => {
  ...
  const board = new Gameboard();
  board.place({ shipUI: ship1, isVertical: false, startX: 1, startY: 1 });
  board.place({ shipUI: ship2, isVertical: true, startX: 3, startY: 3 });
...
test("Passes mockup game session complex test", () => {
  ...
  const board = new Gameboard();
  board.place({ shipUI: ship1, isVertical: false, startX: 3, startY: 5 });
  board.place({ shipUI: ship2, isVertical: true, startX: 2, startY: 3 });
  board.place({ shipUI: ship3, isVertical: true, startX: 9, startY: 5 });
  expect(board.areAllShipsSunk).toBe(false);
