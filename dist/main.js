...
/* harmony export */   MAX_HORIZONTAL: () => (/* binding */ MAX_HORIZONTAL),
/* harmony export */   MAX_VERTICAL: () => (/* binding */ MAX_VERTICAL),
/* harmony export */   PRESSED_MOUSE_BUTTON: () => (/* binding */ PRESSED_MOUSE_BUTTON),
...
function rotateShip() {
  if (!this.isRotated) {
    this.shipElement.style.height = _constants__WEBPACK_IMPORTED_MODULE_0__.TILE_SIZE_PX * this.length + "px";
    this.shipElement.style.width = _constants__WEBPACK_IMPORTED_MODULE_0__.TILE_SIZE_PX + "px";
  } else {
    this.shipElement.style.height = _constants__WEBPACK_IMPORTED_MODULE_0__.TILE_SIZE_PX + "px";
    this.shipElement.style.width = _constants__WEBPACK_IMPORTED_MODULE_0__.TILE_SIZE_PX * this.length + "px";
  }
...
function setupShipElement(shipElement, ID, length, isRotated) {
  ...
  if (isRotated) {
    ...
    shipElement.style.width = _constants__WEBPACK_IMPORTED_MODULE_0__.TILE_SIZE_PX + "px";
    shipElement.style.height = length * _constants__WEBPACK_IMPORTED_MODULE_0__.TILE_SIZE_PX + "px";
  } else {
    shipElement.style.width = length * _constants__WEBPACK_IMPORTED_MODULE_0__.TILE_SIZE_PX + "px";
    shipElement.style.height = _constants__WEBPACK_IMPORTED_MODULE_0__.TILE_SIZE_PX + "px";
  }
  return shipElement;
}
...
function setupShipImage(shipElement, length) {
  ...
  shipImage.style.width = length * _constants__WEBPACK_IMPORTED_MODULE_0__.TILE_SIZE_PX + "px";
  shipImage.style.height = _constants__WEBPACK_IMPORTED_MODULE_0__.TILE_SIZE_PX + "px";
...
class ShipUI {
  ...
  constructor(shipElement, length, isRotated) {
    ...
    shipElement.addEventListener("mousedown", (e) => {
      switch (e.button) {
        case _constants__WEBPACK_IMPORTED_MODULE_0__.PRESSED_MOUSE_BUTTON.LEFT_CLICK:
          ShipUI.movableShip = this;
          prepareShipForDragAndDrop.call(this, e);
          break;

        case _constants__WEBPACK_IMPORTED_MODULE_0__.PRESSED_MOUSE_BUTTON.MIDDLE_CLICK:
...
function isShipInsideByHorizontal(differenceLeft, differenceRight) {
  return (
    (differenceLeft < _constants__WEBPACK_IMPORTED_MODULE_0__.MAX_HORIZONTAL && differenceRight <= 0) ||
    (differenceRight < _constants__WEBPACK_IMPORTED_MODULE_0__.MAX_HORIZONTAL && differenceLeft <= 0)
  );
}

function isShipInsideByVertical(differenceTop, differenceBottom) {
  return (
    (differenceTop < _constants__WEBPACK_IMPORTED_MODULE_0__.MAX_VERTICAL && differenceBottom <= 0) ||
    (differenceBottom < _constants__WEBPACK_IMPORTED_MODULE_0__.MAX_VERTICAL && differenceTop <= 0)
  );
}
